        ...
        <>
            ...
            <ul className="flex gap-4 m-auto">
                {Object.keys(AssetTypes).map((assetName: string, index: number) => {
                    ...
                    const buttonClass: string = "border border-gray-400 shadow rounded p-4 shadow flex flex-col items-center justify-center gap-2 " + ( balance < assetPrice ? " cursor-not-allowed bg-red-200" : " cursor-pointer" );
